      ...
      render: (dom, entity) => {
        return (<>
          <Tooltip placement="top" title="查看" color="#FA541C">
            <Button onClick={() => clickInspect(entity.id)} type="text" icon={<IconFont type='icon-chakan'/>}/>
          </Tooltip>

          <Tooltip placement="top" title="编辑" color="#FA541C">
            <Button onClick={() => clickEdit(entity.id)} type="text" icon={<IconFont type='icon-bianji'/>}/>
          </Tooltip>
